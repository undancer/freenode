...
gunzip lite.gz
wget -O clash_config.yml https://raw.githubusercontent.com/mlwrx1978/freenode/main/utils/speedtest/clash_config.yml
wget -O proxychains.conf https://raw.githubusercontent.com/mlwrx1978/freenode/main/utils/speedtest/proxychains.conf
wget -O lite_config.json https://raw.githubusercontent.com/mlwrx1978/freenode/main/utils/speedtest/lite_config.json
#初始化 Clash
chmod +x ./clash && ./clash &
#安装并配置 proxychains
