...
#运行 LiteSpeedTest
chmod +x ./lite
sudo nohup proxychains ./lite --config ./lite_config.json --test https://raw.githubusercontent.com/mlwrx1978/freenode/master/sub/sub_merge_yaml.yml >speedtest.log 2>&1 &
